...
const StyleSelector = ({
  ...
  const styleDescriptions: Record<ThumbnailStyle, string> = {
    "Bold & Graphic": "High contrast,vibrant colors and striking visuals",
    "Minimalist": "Simple design, ample white space and a focus on typography",
    "Photorealistic": "Lifelike images with attention to detail and realism",
    "Illustrated": "Hand-drawn or digitally created illustrations with a unique artistic flair",
    "Tech/Futuristic": "Sleek, modern designs with a focus on technology and innovation",
  };
  ...
  return (
    <div className="relative space-y-3 dark">
      ...
      >
       ...
       <ChevronDownIcon className={["h-5 w-5 text-zinc-400 transition-transform", isOpen && "rotate-180" ].join(" ")}></ChevronDownIcon>
      </button>
      {isOpen && (
